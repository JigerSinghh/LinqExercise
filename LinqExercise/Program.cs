...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            employees = employees.Append(new Employee("Micheal", "Tarintino", 37, 5)).ToList();
        ...
        private static List<Employee> CreateEmployees()
        {
            ...
            employees.Add(new Employee("Loke", "Stephens", 25, 10));
            employees.Add(new Employee("Bryan", "Smith", 56, 5));
            employees.Add(new Employee("Mike", "Pab", 36, 8));
            employees.Add(new Employee("Lily", "Pugh", 72, 22));
            employees.Add(new Employee("Greta", "Clarkson", 32, 43));
            employees.Add(new Employee("Jerry", "Gill", 14, 1));
            employees.Add(new Employee("Shanvir", "Singh", 23, 14));
            employees.Add(new Employee("Gaurav", "Singh", 18, 3));
            employees.Add(new Employee("Trent", "Pugh", 44, 7));
            employees.Add(new Employee("Mandeep", "Gill", 32, 10));
